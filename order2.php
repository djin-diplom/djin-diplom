...
<div id="win1">
			...
			<p  style="font-size: 17px;">Спасибо  <strong><?php echo $name;?></strong> за использование контактной формы! Мы свяжемся с Вами в кратчайшие сроки. <br><a href="index.php">Вернуться на главную</a></p>
			<?php } ?><br>
		</div>
		</div>
</body>
